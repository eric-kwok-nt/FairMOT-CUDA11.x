...
```
**¡Modifications!**
* It uses [DCNv2 with Pytorch 1.8+ & JIT Compilation](https://github.com/tteepe/DCNv2) in the backbone network instead of the original versions, which can be found in [DCNv2_pytorch_1.7](https://github.com/ifzhang/DCNv2/tree/pytorch_1.7) and [DCNv2](https://github.com/CharlesShang/DCNv2).
